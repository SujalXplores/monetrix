...
import type {
  ...
  StockFilterParams,
  StockPriceParams,
} from '@/lib/types/financial-tool-types';
import {
  createStandardErrorResponse,
  isApiKeyError,
  isPaymentError,
  logApiError,
} from '@/lib/utils/api-error-patterns';
...
export class FinancialToolsManager {
  ...
  private async handleApiError(response: Response, context: string) {
    ...
    if (isPaymentError(response.status, errorText)) {
      return {
    ...
    if (isApiKeyError(response.status, errorText)) {
      return {
  ...
  public getTools() {
    return {
      getNews: {
        ...
        execute: async (params: NewsParams) => {
          const { ticker, limit } = params;

          try {
            const response = await fetch(
              `https://api.financialdatasets.ai/news/?ticker=${ticker}&limit=${limit}`,
              {
                headers: {
            ...
            if (!response.ok) {
              ...
              return {
                ...
                message: `Failed to fetch news data: ${response.statusText}`,
                status: response.status,
              };
            }
            ...
            return {
              ...
              message: `Failed to fetch news data: ${error instanceof Error ? error.message : 'Unknown error occurred'}`,
              status: 500,
            };
          }
        },
      ...
      getStockPrices: {
        ...
        execute: async (params: StockPriceParams) => {
          const {
            ticker,
            start_date,
            end_date,
          ...
          if (
            !this.shouldExecuteToolCall('getStockPrices', {
              ticker,
              start_date,
              end_date,
              interval,
            ...
            logger.debug('Skipping duplicate getStockPrices call', {
              ticker,
              start_date,
              end_date,
              interval,
          ...
          try {
            ...
            if (!snapshotResponse.ok) {
              if (snapshotResponse.status === 402) {
                return {
                  error: '💳 Financial data API credits exhausted',
                  message:
                    'Your Financial Datasets API account has insufficient credits. Please add more credits at https://financialdatasets.ai or update your API key in settings.',
                  status: 402,
                };
              }
              ...
              return {
                error: `🚫 API error (${snapshotResponse.status})`,
                message: `Failed to fetch stock prices for ${ticker}: ${snapshotResponse.statusText}`,
            ...
            const historicalPricesResponse = await fetch(
              `https://api.financialdatasets.ai/prices/?${urlParams}`,
              {
                headers: {
                  'X-API-Key': this.config.financialDatasetsApiKey,
                },
            ...
            if (!historicalPricesResponse.ok) {
              if (historicalPricesResponse.status === 402) {
                return {
                  error: '💳 Financial data API credits exhausted',
                  message:
                    'Your Financial Datasets API account has insufficient credits. Please add more credits at https://financialdatasets.ai or update your API key in settings.',
              ...
              if (historicalPricesResponse.status === 401) {
                return {
                  error: '🔑 Authentication failed',
                  message:
                    'Invalid or missing Financial Datasets API key. Please check your API key in settings.',
              ...
              return {
                error: `🚫 API error (${historicalPricesResponse.status})`,
                message: `Failed to fetch historical prices for ${ticker}: ${historicalPricesResponse.statusText}`,
            ...
            return {
              ...
              message: `Failed to fetch stock prices for ${ticker}: ${error instanceof Error ? error.message : 'Unknown error'}`,
              status: 500,
            };
          }
        },
      ...
      getIncomeStatements: {
        ...
        parameters: z.object({
          ...
          report_period_lte: z
            ...
            .optional()
            .describe(
              'The less than or equal to date of the income statements to return.  This lets us bound the data by date.',
            ),
          report_period_gte: z
            .string()
            .optional()
            .describe(
              'The greater than or equal to date of the income statements to return.  This lets us bound the data by date.',
            ),
        }),
        execute: async (requestParams: FinancialStatementParams) => {
          const {
            ticker,
            period,
            limit,
          ...
          if (
            !this.shouldExecuteToolCall('getIncomeStatements', {
              ticker,
              period,
              limit,
              report_period_lte,
            ...
            logger.debug('Skipping duplicate getIncomeStatements call', {
              ticker,
              period,
              limit,
              report_period_lte,
          ...
          if (report_period_lte)
            params.append('report_period_lte', report_period_lte);
          if (report_period_gte)
            params.append('report_period_gte', report_period_gte);

          try {
            const response = await fetch(
              `https://api.financialdatasets.ai/financials/income-statements/?${params}`,
              {
                headers: {
                  'X-API-Key': this.config.financialDatasetsApiKey,
                },
            ...
            if (!response.ok) {
              return this.handleApiError(
                response,
                `fetch income statements for ${ticker}`,
              );
            }
            ...
            return {
              error: '🚫 Unexpected error occurred',
              message: `Failed to fetch income statements for ${ticker}: ${error instanceof Error ? error.message : 'Unknown error'}`,
              status: 500,
            };
          }
        },
      ...
      getBalanceSheets: {
        ...
        parameters: z.object({
          ...
          report_period_lte: z
            ...
            .optional()
            .describe(
              'The less than or equal to date of the balance sheets to return.  This lets us bound the data by date.',
            ),
          report_period_gte: z
            .string()
            .optional()
            .describe(
              'The greater than or equal to date of the balance sheets to return.  This lets us bound the data by date.',
            ),
        }),
        execute: async ({
          ticker,
          ...
          if (
            !this.shouldExecuteToolCall('getBalanceSheets', {
              ticker,
              period,
              limit,
              report_period_lte,
            ...
            logger.debug('Skipping duplicate getBalanceSheets call', {
              ticker,
              period,
              limit,
              report_period_lte,
          ...
          const response = await fetch(
            `https://api.financialdatasets.ai/financials/balance-sheets/?${params}`,
            {
              headers: {
                'X-API-Key': this.config.financialDatasetsApiKey,
              },
      ...
      getCashFlowStatements: {
        ...
        parameters: z.object({
          ...
          report_period_lte: z
            ...
            .optional()
            .describe(
              'The less than or equal to date of the cash flow statements to return.  This lets us bound the data by date.',
            ),
          report_period_gte: z
            .string()
            .optional()
            .describe(
              'The greater than or equal to date of the cash flow statements to return.  This lets us bound the data by date.',
            ),
        }),
        execute: async ({
          ticker,
          ...
          if (
            !this.shouldExecuteToolCall('getCashFlowStatements', {
              ticker,
              period,
              limit,
              report_period_lte,
            ...
            logger.debug('Skipping duplicate getCashFlowStatements call', {
              ticker,
              period,
              limit,
              report_period_lte,
          ...
          const response = await fetch(
            `https://api.financialdatasets.ai/financials/cash-flow-statements/?${params}`,
            {
              headers: {
                'X-API-Key': this.config.financialDatasetsApiKey,
              },
      ...
      getFinancialMetrics: {
        ...
        parameters: z.object({
          ...
          report_period_lte: z
            ...
            .optional()
            .describe(
              'The less than or equal to date of the financial metrics to return.  This lets us bound the data by date.',
            ),
          report_period_gte: z
            .string()
            .optional()
            .describe(
              'The greater than or equal to date of the financial metrics to return.  This lets us bound the data by date.',
            ),
        }),
        execute: async ({
          ticker,
          ...
          if (
            !this.shouldExecuteToolCall('getFinancialMetrics', {
              ticker,
              period,
              limit,
              report_period_lte,
            ...
            logger.debug('Skipping duplicate getFinancialMetrics call', {
              ticker,
              period,
              limit,
              report_period_lte,
          ...
          if (report_period_gte)
            params.append('report_period_gte', report_period_gte);
          const response = await fetch(
            `https://api.financialdatasets.ai/financial-metrics/?${params}`,
            {
              headers: {
                'X-API-Key': this.config.financialDatasetsApiKey,
              },
      ...
      searchStocksByFilters: {
        ...
        parameters: z.object({
          filters: z
            ...
            .describe(
              'The filters to search for (e.g. [{field: "net_income", operator: "gt", value: 1000000000}, {field: "revenue", operator: "gt", value: 50000000000}])',
            ),
          period: z
            .enum(['quarterly', 'annual', 'ttm'])
            .optional()
        ...
        execute: async (requestParams: StockFilterParams) => {
          const { filters, period, limit } = requestParams;

          if (
            !this.shouldExecuteToolCall('searchStocksByFilters', {
              filters,
              period,
              limit,
            })
          ) {
            logger.debug('Skipping duplicate searchStocksByFilters call', {
              filters,
              period,
              limit,
            });
          ...
          try {
            ...
            const response = await fetch(
              'https://api.financialdatasets.ai/financials/search/',
              {
                method: 'POST',
                headers: {
                  'X-API-Key': this.config.financialDatasetsApiKey,
            ...
            if (!response.ok) {
              ...
              return this.handleApiError(response, 'search stocks');
            }
            ...
            return {
              error: '🚫 Unexpected error occurred',
              message: `Failed to search stocks due to an unexpected error: ${error instanceof Error ? error.message : 'Unknown error'}. Please try again later.`,
              status: 500,
            };
          }
        },
