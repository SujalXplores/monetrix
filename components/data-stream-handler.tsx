...
import { CONTENT_VISIBILITY } from '@/lib/constants';
import type {
  DataStreamDelta,
  QueryLoadingContent,
  ToolLoadingContent,
          ...
          case 'text-delta':
            return {
              ...
              isVisible:
                ...
                draftBlock.content.length >
                  CONTENT_VISIBILITY.TEXT_MIN_LENGTH &&
                draftBlock.content.length < CONTENT_VISIBILITY.TEXT_MAX_LENGTH
                  ? true
          ...
          case 'code-delta':
            return {
              ...
              isVisible:
                draftBlock.status === 'streaming' &&
                draftBlock.content.length >
                  CONTENT_VISIBILITY.CODE_MIN_LENGTH &&
                draftBlock.content.length < CONTENT_VISIBILITY.CODE_MAX_LENGTH
                  ? true
                  : draftBlock.isVisible,
              status: 'streaming',
            };
